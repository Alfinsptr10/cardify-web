...
function AboutContent() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#FDFBF3] text-[#1C1917] selection:bg-[#F6C445] selection:text-[#1C1917] flex flex-col relative overflow-hidden font-sans">
      ...
      {/* --- HERO SECTION (Lilac paper) --- */}
      <section className="pt-44 pb-24 px-6 relative z-10 bg-[#D8C9F2] border-t-4 border-b-4 border-[#111111]">
         <motion.div
         ...
         >
            ...
            >
               We believe every moment deserves to be celebrated.
            </motion.h1>
            <motion.p variants={staggerItem} className="text-[14px] font-bold font-sans text-[#1C1917]/60">私たちは、すべての瞬間は祝う価値があると信じています</motion.p>
      ...
      <section className="py-24 bg-[#B8E3C9] border-t-0 border-[#111111]">
         <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16 max-w-2xl mx-auto">
               ...
               <p className="mt-3 text-[14px] font-bold font-sans text-[#1C1917]/60">私たちの価値観</p>
            </div>
            <motion.div
      ...
      <section className="py-24 bg-[#BFE0F5] border-t-4 border-[#111111]">
         <div className="max-w-5xl mx-auto px-6 text-center">
            ...
            <p className="text-[14px] font-bold font-sans text-[#1C1917]/60 mb-12">作った人について</p>
            ...
            <motion.div
               ...
               viewport={{ once: true, margin: "-100px" }}
               transition={{ duration: 0.6, ease: "easeOut" }}
               className="bg-white p-8 md:p-12 rounded-[2.5rem] border-2 border-[#1C1917] shadow-[8px_8px_0_0_#1C1917] flex flex-col md:flex-row items-center gap-10 text-left"
            >
               <div className="w-48 h-48 md:w-64 md:h-64 bg-stone-200 rounded-2xl overflow-hidden flex-shrink-0 relative border-2 border-[#1C1917] shadow-[5px_5px_0_0_#1C1917] transform md:-rotate-3 hover:rotate-0 transition-transform duration-300">
                  {/* Foto Creator */}
                  <Image 
                    src="/alfin.jpg" 
                    fill 
               ...
               <div className="space-y-6">
                  ...
                  <div className="flex gap-4 pt-2">
                     <Link href="https://instagram.com/alfinnsptr" target="_blank" className="p-3 bg-[#FDFBF3] border-2 border-[#1C1917] rounded-full text-stone-600 hover:bg-[#E1306C] hover:text-white hover:border-[#E1306C] transition-all"><Instagram size={20}/></Link>
                     <Link href="mailto:hello@cardify.id" className="p-3 bg-[#FDFBF3] border-2 border-[#1C1917] rounded-full text-stone-600 hover:bg-[#1C1917] hover:text-white transition-all"><Mail size={20}/></Link>
                     <Link href="#" className="p-3 bg-[#FDFBF3] border-2 border-[#1C1917] rounded-full text-stone-600 hover:bg-[#1C1917] hover:text-white transition-all"><Globe size={20}/></Link>
                  </div>
               </div>
            </motion.div>
         </div>
      ...
      {/* --- FOOTER (sama seperti homepage & templates) --- */}
      <footer
    ...
    >
      ...
      <div>
        ...
        <ul className="space-y-2 text-sm font-bold">
          ...
          <li>
            <a href="/about" className="hover:opacity-60" style={{ color: "#FFFFFF" }}>
              About
            </a>
          </li>
