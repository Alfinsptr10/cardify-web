...
function TemplatesContent() {
  ...
  const jsonLd = {
    ...
    "itemListElement": templates.map((template, index) => ({
      "@type": "ListItem",
      "position": index + 1,
      "url": `https://cardify-web-kappa.vercel.app${template.href}`,
      "name": template.title,
      "description": template.description,
      "image": `https://cardify-web-kappa.vercel.app${template.image}`
    }))
  };
        ...
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center relative">
          ...
          <Link href="/" className="flex items-center gap-5 cursor-pointer group">
            ...
            <div className="leading-none">
              <div className="text-[9px] font-black uppercase tracking-[0.2em] text-[#1C1917]">A CARD WITH A STORY</div>
              <div className="text-2xl font-black italic tracking-[-0.02em]" style={{ fontFamily: "'Boldonse', 'Archivo Black', sans-serif", color: "#1C1917" }}>
                cardify
              </div>
            </div>
          </Link>
          ...
          <div className="flex items-center gap-4">
            {userData ? (
              ...
              <div className="hidden md:flex items-center gap-6">
                <Link href="/login" className="text-sm font-bold uppercase tracking-wide text-stone-600 hover:text-black transition-colors">Log in</Link>
                <Link href="/register" className="text-sm font-bold uppercase tracking-wide text-stone-600 hover:text-black transition-colors">Sign Up</Link>
              </div>
            )}
  ...
  <motion.div key={template.id} variants={staggerItem} className="relative block h-full pt-3 pr-3">
      ...
      {/* --- FOOTER --- */}
      <footer className="relative isolate w-full border-t-[2.5px] px-6 py-12 overflow-hidden" style={{ background: "#84D4A4", borderColor: "#1C1917" }}>
          ...
          <div className="mb-12 grid grid-cols-2 gap-10 md:grid-cols-4">
            <div className="col-span-2 md:col-span-1">
               <div className="mb-4 flex items-start gap-1">
                <div className="w-20 h-20 flex items-center justify-center overflow-visible">
                  <img src="/logo-cardify.svg" alt="Cardify" className="w-full h-full object-contain -mt-11 scale-70 drop-shadow-[0_2px_3px_rgba(28,25,23,0.25)]" />
                </div>
                <div className="leading-none">
                  <div className="text-[9px] font-black uppercase tracking-[0.2em]" style={{ color: "#1C1917" }}>A CARD WITH A STORY</div>
                  <div className="text-2xl font-black italic tracking-[-0.02em]" style={{ fontFamily: "'Boldonse', 'Archivo Black', sans-serif", color: "#1C1917" }}>
                    cardify
                  </div>
                </div>
            ...
            <div>
              ...
              <div className="flex flex-col gap-3">
                <a href="https://instagram.com/alfinnsptr" target="_blank" className="flex items-center gap-3 hover:opacity-60" style={{ color: "#1C1917" }}>
                ...
                <a href="https://wa.me/6289501847804" target="_blank" className="flex items-center gap-3 hover:opacity-60" style={{ color: "#1C1917" }}>
                  <div className="flex h-8 w-8 items-center justify-center rounded-full border-2" style={{ background: "#FDFBF3", borderColor: "#1C1917" }}>
